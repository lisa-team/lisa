# -*- coding: utf-8 -*-
""" A collection of for expansion of osmnx graph to directed graph

This module needs a top-level explanation right here.
TODO do this ^^^
...
# TODO I think this file should have only stuff from Nathan's expansion stuff
...
def osmnx_graph_to_expander_stuff(blah, blah2, blah3):
